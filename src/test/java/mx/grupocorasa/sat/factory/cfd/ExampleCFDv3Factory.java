...
public class ExampleCFDv3Factory {

    private static ExampleCFDv3Factory instance;

    private final ObjectFactory of;

    private ExampleCFDv3Factory() {
        of = new ObjectFactory();
    }

    public static ExampleCFDv3Factory getInstance() {
        if (instance == null) {
            instance = new ExampleCFDv3Factory();
        }
        return instance;
    }
...
//        comp.setCertificado();
        comp.setCondicionesDePago("Factura de Contado");
        ...
        comp.setMetodoDePago("Tarjeta de Débito");
