package com.angelsoft.sat.cfdi.v3;

import com.angelsoft.sat.cfd._32.Comprobante;
...
import com.angelsoft.sat.common.nomina11.Nomina;
import com.angelsoft.sat.factory.cfd.ExampleCFDv32Factory;
import com.angelsoft.sat.factory.common.ExampleNomina11Factory;
import com.angelsoft.sat.factory.common.ExampleTimbreFiscal10Factory;
...
public final class CFDv32Test {
    ...
    public void testComprobanteTFD() throws Exception {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            cfd.verificar();
            cfd.guardar(outputStream, false);
            Assert.assertEquals(cfdi_tfd, outputStream.toString("UTF-8"));
        }
    }
